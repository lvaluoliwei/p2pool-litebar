...
nets = dict(
    ...
    litebar=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://bt.nice-media.ru/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://bt.nice-media.ru/address/',
        TX_EXPLORER_URL_PREFIX='http://bt.nice-media.ru/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
